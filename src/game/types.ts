...
export type GameIntent = { readonly type: 'move'; readonly dx: -1 | 1 } | { readonly type: 'rotate'; readonly direction: -1 | 1 } | { readonly type: 'start' } | { readonly type: 'soft-drop' | 'hard-drop' | 'place' | 'undo' | 'pause' | 'resume' | 'tick' | 'remove-provenance' | 'restore-provenance' };
